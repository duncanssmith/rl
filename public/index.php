...
for further information and availability. A non-returnable 20% deposit is required to secure booking.
    ...
    <section id="section-access" class="section photo">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="pictures.php"><img src="media/images/<?php echo $images[4]?>" border="0"></a></p>
                </div>
                <div class="col-md-6">
    ...
    <section id="section-location" class="section photo">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="pictures.php"><img src="media/images/<?php echo $images[0]?>" border="0"></a></p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="pictures.php"><img src="media/images/<?php echo $images[3]?>" border="0"></a></p>
                </div>
            </div>
        </div>
    </section>
